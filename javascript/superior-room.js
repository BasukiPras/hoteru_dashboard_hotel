...
let getData = localStorage.getItem('userProfileSuperior') ? JSON.parse(localStorage.getItem('userProfileSuperior')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfileSuperior", JSON.stringify(getData))
        showData( getData )
    }
}
...
form.addEventListener('submit', (e)=> {
    ...
    localStorage.setItem('userProfileSuperior', JSON.stringify(getData))
    console.log(localStorage.getItem("userProfileSuperior"))
